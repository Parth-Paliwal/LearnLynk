...
function VideoPlayer({ width = "100%", height = "100%", url , onProgressUpdates , progressData}) {
  ...
  return (
    ...
    >
      ...
      {showControls && (
        <div
          className={`absolute w-full bottom-0 left-0 bg-gray-800 bg-opacity-75 p-4 transition-opacity duration-300
            ...
            <div className="flex items-center space-x-2 ">
                    ...
                    <Button onClick={handleFullScreen} variant="ghost" size="icon"
                                    className="text-white bg-transparent hover:text-white hover:bg-gray-700">
                                        {
                                            isFullScreen?
                                                <Minimize className="h-6 w-6"/> : <Maximize className="h-6 w-6" />
                                        }
